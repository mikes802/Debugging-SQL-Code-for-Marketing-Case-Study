...
Again, this is a follow-up to solving the marketing analytics case study from [Danny Ma's Serious SQL course](https://www.datawithdanny.com/ "Data With Danny"). My original work can be found here: [Marketing Analytics Case Study](https://github.com/mikes802/Marketing-Analytics-Case-Study).
